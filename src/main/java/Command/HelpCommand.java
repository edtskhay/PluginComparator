...
public class HelpCommand {
    ...
    private final String helpMessage =
            ...
            -------------------------
            Usage:
              java -cp <classpath> App <command> [options]
            ...
            Examples:
              java -cp target/classes;target/dependency/* App extract -i plugin.zip -o entries.txt
              java -cp target/classes;target/dependency/* App compare -f entries1.txt -s entries2.txt
